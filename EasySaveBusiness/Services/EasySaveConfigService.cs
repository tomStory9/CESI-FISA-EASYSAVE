...
namespace EasySaveBusiness.Services
{
    public class EasySaveConfigService
    {
        ...
        public EasySaveConfig EasySaveConfig { get; private set; } = new EasySaveConfig(new List<BackupConfig>(), "notepad.exe", LoggerDLL.Models.LogType.LogTypeEnum.JSON,new List<string>(),0 );
        ...
        private void Init()
        {
            try
            {
                ...
                {
                    EasySaveConfig = new EasySaveConfig(new List<BackupConfig>(), "notepad.exe", LoggerDLL.Models.LogType.LogTypeEnum.JSON, new List<string>(), 0);
        ...
        private void Save()
        {
            try
            {
                ...
                EasySaveConfig = new EasySaveConfig(BackupConfigs, EasySaveConfig.WorkApp, EasySaveConfig.LogType, EasySaveConfig.PriorityFileExtension, EasySaveConfig.NetworkKoLimit);
